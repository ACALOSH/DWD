const deckCards = ["kawaii.cat1.png", "kawaii.cat1.png", "kawaii.cat2.png", "kawaii.cat2.png", "kawaii.cat3.png", "kawaii.cat3.png", "kawaii.cat4.png", "kawaii.cat4.png", "kawaii.cat5.png", "kawaii.cat5.png", "kawaii.cat6.png", "kawaii.cat6.png", "kawaii.cat7.png", "kawaii.cat7.png", "kawaii.cat8.png", "kawaii.cat8.png"];
...
function startGame() {
    ...
    for (let i = 0; i < shuffledDeck.length; i++) {
        ...
        addImage.setAttribute("src", "ui/images/" + shuffledDeck[i]);
        // Add an alt tag to the image
        addImage.setAttribute("alt", "kawaii cats");
...
function noMatch() {
    /* After 700 milliseconds the two cards open will have
